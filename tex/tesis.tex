...
\begin{figure}[H]
	...
	\includegraphics[width=0.45\textwidth]{tesis_74.png}
  	\caption{Gráfico de barras del rendimiento de cada modelo para \texttt{TIPO}.}
  	\label{fig:sklearn}
  	\end{center}
\end{figure}
