...
\author{Gerardo A. COLLANTE \\ email: \href{mailto:gerardo.collante@unc.edu.ar}{gerardo.collante@unc.edu.ar} \\ cel: 54 (03574) 650490}
...
\begin{titlepage}
	...
	%{\normalsize \textbf{Matrícula}: 39.022.782}}
	%{\normalsize \textbf{Correo institucional}: gerardo.collante@unc.edu.ar}
	%{\normalsize \textbf{Matrícula}: 39.022.782}
...
\begin{itemize}
	...
	Uno de los objetivos que tiene el arquitectura de computadoras es formar alumnos en el campo de la IA aplicada. Evaluar los diversos algoritmos disponibles de \textit{Machine Learning}, explorando todas las posibilidades en aras de identificar el modelo que mejor se adapte al problema a afrontar.
	...
	Calcular de forma teórica la entropía de una serie temporal con la finalidad de cuantificar la cantidad de información.
...
\begin{figure}[H]
	\begin{center}				
	\includegraphics[width=0.70\textwidth]{imgrgb.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.58\textwidth]{hyper_trials_vs_epochs.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.77\textwidth]{comparison_rs_hb.png}
