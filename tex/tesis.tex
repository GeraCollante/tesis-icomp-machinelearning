...
Ya definido el espacio de búsqueda de los modelos, se procede a la búsqueda del mejor conjunto de hiperparámetros obteniendo la tabla \ref{tab:tuning-hp}. De la misma podemos sacar varias conclusiones interesantes.
\begin{itemize}
...
Ahora haremos énfasis en los rendimientos por arquitectura de los dos algoritmos de ajuste de hiperparámetros utilizados. Para esta tarea utilizaremos de soporte la tabla~\ref{tab:algo_vs_arch} y la fig.~\ref{fig:algo_comparison}. Notamos que exceptuando \texttt{LSTM}, \textit{Hyperband} se desempeña mejor en cada uno de los modelos restantes.
...
\textit{BayesianOptimization}         & 0.012601     & 0.012236        & 0.012216         & 0.012178     & 0.011973      \\
\textit{Hyperband}         & 0.012133     & 0.011961        & 0.012030         & 0.012036     & 0.012021      \\ \hline
\end{tabular}
\caption{Mejor puntuación por algoritmo y arquitectura.}
\label{tab:algo_vs_arch}
\end{table}

\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.8\textwidth]{model_vs_algo_hp.png}
  	\caption{Comparación de algoritmos de ajuste de hiperpárametros por modelo y arquitectura.}
