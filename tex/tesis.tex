...
\begin{figure}[H]
	...
	\includegraphics[width=0.7\textwidth]{audidist.png}
  	\caption{Distribución de los defectos según auditoria.}
  	\label{fig:distaudi}
  	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.7\textwidth]{tesis_53.png}
  	\caption{Distribución de los defectos por departamento.}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.7\textwidth]{tesis_55.png}
  	\caption{Distribución de los defectos por tipo.}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\textwidth]{tesis_56.png}
  	\caption{Cantidad de defectos cruzando familias y tipos.}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\textwidth]{tesis_64.png}
  	\caption{Defectos diarios agrupados por gravedad.}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\textwidth]{tesis_63.png}
  	\caption{Defectos semanales agrupados por gravedad.}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\textwidth]{audigvd.png}
  	\caption{Defectos semanales agrupados por auditoria/gravedad.}
